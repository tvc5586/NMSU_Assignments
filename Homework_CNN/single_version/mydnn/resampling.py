    ...
    def forward(self, A):
        ...
        for sample in range(N):
            ...
            for channel in range(C):
                # Loop through width
                for j in range(Win):
                    Z[sample][channel][j * self.upsampling_factor] = A[sample][channel][j]
        ...
        for sample in range(N):
            ...
            for channel in range(C):
                ...
                for j in range(0, Wout, self.upsampling_factor):
                    dLdA[sample][channel][col] = dLdZ[sample][channel][j]
        ...
        for sample in range(N):
            ...
            for channel in range(C):
                ...
                for j in range(0, self.Win, self.downsampling_factor):
                    Z[sample][channel][col] = A[sample][channel][j]
    ...
    def backward(self, dLdZ):
        ...
        for sample in range(N):
            ...
            for channel in range(C):
                # Loop through width
                for j in range(Wout):
                    factor = j * self.downsampling_factor
                    dLdA[sample][channel][factor] = dLdZ[sample][channel][j]
        ...
        for sample in range(N):
            ...
            for channel in range(C):
                ...
                for i in range(Hin):
                    # Loop through width
                    for j in range(Win):
                        Z[sample][channel][i * self.upsampling_factor, j * self.upsampling_factor] = A[sample][channel][i, j]
        ...
        for sample in range(N):
            ...
            for channel in range(C):
                ...
                for i in range(0, Hout, self.upsampling_factor):
                    ...
                    for j in range(0, Wout, self.upsampling_factor):
                        dLdA[sample][channel][row, col] = dLdZ[sample][channel][i, j]
        ...
        for sample in range(N):
            ...
            for channel in range(C):
                ...
                for i in range(0, self.Hin, self.downsampling_factor):
                    ...
                    for j in range(0, self.Win, self.downsampling_factor):
                        Z[sample][channel][row, col] = A[sample][channel][i, j]
        ...
        for sample in range(N):
            ...
            for channel in range(C):
                ...
                for i in range(Hout):
                    # Loop through width
                    for j in range(Wout):
                        dLdA[sample][channel][i * self.downsampling_factor, j * self.downsampling_factor] = dLdZ[sample][channel][i, j]
