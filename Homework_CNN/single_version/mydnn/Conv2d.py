                        ...
                        for n in range(self.in_channels):
                            ...
                            for ik in range(self.kernel_size):
                                ...
                                for jk in range(self.kernel_size):
                                    Z[sample, m, i, j] += np.dot(self.W[m, n, ik, jk],
                                                                 A[sample, n, i + ik, j + jk])

                        Z[sample, m, i, j] += self.b[m] # Add bias
                        ...
                        for n in range(in_channels - 1, -1, -1):
                            ...
                            for ik in range(self.kernel_size - 1, -1, -1):
                                ...
                                for jk in range(self.kernel_size - 1, -1, -1):
                                    dLdA[sample, n, i + ik, j + jk] += np.dot(self.W[m, n, ik, jk],
                                                                                      dLdZ[sample, m, i, j])

                                    self.dLdW[m, n, ik, jk] += np.dot(self.A[sample, n, i + ik, j + jk],
                                                                      dLdZ[sample, m, i, j])
